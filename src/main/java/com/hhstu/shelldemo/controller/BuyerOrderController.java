...
import com.hhstu.shelldemo.converter.OrderForm2OrderDTOConverter;
...
import com.hhstu.shelldemo.form.OrderForm;
import com.hhstu.shelldemo.service.BuyerService;
...
public class BuyerOrderController {
    ...
    public ResultVO<List<OrderDTO>> list(@RequestParam("openid") String openid,
                                         @RequestParam(value = "page",defaultValue = "0") Integer page,//设置默认值为 0
